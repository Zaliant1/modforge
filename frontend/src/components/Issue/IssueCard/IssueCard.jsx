    ...
    >
      ...
      <Box sx={useStyles(styles, 'issue-card__meta')}>
        <Box sx={useStyles(styles, 'issue-card__icons')}>
          <PriorityIcon type={priority} sx={useStyles(styles, `issue-card__priority--${priority}`)} />
          <TypeIcon type={type} sx={useStyles(styles, 'issue-card__type')} />
          <OsIcon os={operating_systems} />
        </Box>
